<template>
  ...
  >
    <g
      ...
      stroke-width="0"
      transform="translate(43.52000000000001,43.52000000000001), scale(0.83)"
    >
      <rect
        x="-51.2"
        y="-51.2"
...
import { colorWhite, red } from '@/styles/variables.styles'
...
const { color = red, backgroundColor = colorWhite } = defineProps<Props>()
</script>
